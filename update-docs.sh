...
documentation build pannellum/src/js/pannellum.js pannellum/src/js/libpannellum.js -f md --name Pannellum --project-version `cat pannellum/VERSION` >> content/documentation/api/index.md
